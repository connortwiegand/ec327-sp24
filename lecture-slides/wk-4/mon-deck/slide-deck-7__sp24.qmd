...
![](imgs/entrant-game.png){fig-align="right" width="40%"}
...
![](imgs/ent-path.png){fig-align="right width=40%}
...
![](imgs/basic-game.png){fig-align="right" width=80%}
...
![](imgs/egame-test.png){fig-align="right" width=40%}
...
![](imgs/chicken.png){fig-align="right" width=40%}
...
![](imgs/sfg-chicken.png){fig-align="right"" width=40%}
...
![](imgs/entrant-game.png){fig-align="right" width=50%}
...
![](imgs/sfg-ent.png){fig-align="right" width=50%}
...
![](imgs/hidden-chicken.png){fig-align="right" width=40%}
