...
#canvas({
  ...
  let (a, b) = ("tr.0-1-0", "tr.0-1-1")
  line((a, .5, b), (b, .5, a), stroke: (thickness: 1.5pt, dash: "dashed"))

  rect(
    (rel: (-0.75,-0.5), to: ("tr.0-1-0-0")),
    (rel: (5.5,0.75), to: ("tr.0-1")), radius: (north: 50%, south: 10%), stroke: (dash: "dashed", paint: red), name: "r-rect")
  content((rel: (-2,1.5), to: (name: "r-rect", anchor: 45deg)), text(size: 1.33em, fill: red, [SG 1]))
  // circle((rel: (0,0), to: ("tr.center")), radius: 6, stroke: (dash: "dashed", paint: gray), name: "g-circ")
  rect((rel: (-1,-7.5), to: ("tr.0-0")), (rel: (14,14)), radius: 10%, stroke: (dash: "dashed", paint: gray), name: "g-rect")
  content((rel: (-2,0), to: (name: "g-rect", anchor: 45deg)), text(size: 1.33em, fill: gray, [SG 0]))
}) //end canvas