...
- Maintain G.T. when
   ...
   24\delta &> 20\\
   \delta &> \frac{20}{24}=\frac{5}{6}=0.8\bar{3}
   \end{aligned}
   $$
...
- What happens if you get $\delta < 0$?
   ...
   - This means the assumed condition to get us to that point [_never_]{.ul} happens^[I had discounting in mind, but we also don't typically think of negative discount factors as this would imply interest rates are in excess of $-100\%$]
