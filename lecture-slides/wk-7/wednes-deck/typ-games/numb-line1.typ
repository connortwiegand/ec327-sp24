...
#canvas({
  ...
  content(((1/4 * ep, 1.85), 50%, (3/4 * ep,1.85)), text(fill: blue, $1/4 <= delta <= 3/4$))


  // set-style(mark: (symbol: ">"), fill: purple)
  // line((1/4 * ep, 0), (3/4 * ep, 0), stroke: purple)
  // set-style(mark: (symbol: none), fill: purple)
  // line((1/4 * ep, -.1), (1/4 * ep, .1), stroke: purple)
  // line((3/4 * ep, -.1), (3/4 * ep, .1), stroke: purple)

  // content(((1/4 * ep, 1.85), 50%, (3/4 * ep,1.85)), fill: red, text(fill: blue, $1/4 <= delta <= 3/4$))
